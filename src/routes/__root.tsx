  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "SpinPick — Random Choice Wheel" },
      {
        ...
        content: "A calm, premium random picker wheel.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;600;700&family=Poppins:wght@600;700;800&display=swap",
      },
